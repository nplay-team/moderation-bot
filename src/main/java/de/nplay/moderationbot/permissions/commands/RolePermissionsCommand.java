...
public class RolePermissionsCommand extends PermissionsCommand {
    ...
    public void onConfirm(ComponentEvent event) {
        replyList(event, permissionsService.updateRole(role, 0, event.getMember()), role.getAsMention());
    }
    ...
    public void onSave(ComponentEvent event) {
        ...
        if (newPermissions == null) {
            ...
            permissions = permissionsService.updateRole(role, newPermissions, event.getMember());
        }
