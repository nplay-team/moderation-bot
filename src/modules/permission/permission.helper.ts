...
/**
 * Get the permission choices for a select menu
 * @param defaultValues The default values to pre-select
 * @returns The permission choices for a select menu
 */
export function getPermissionChoices(defaultValues: string[] = []) {
